...
This file provides guidance to coding assistants working with code in this repository.
...
3. **AI 服务集成**:
   - `client.videos.generations()` 调用视频模型服务生成视频
...
client = VideoClient(api_key="YOUR_API_KEY")
```
...
3. **并发限制**: 视频生成 API 有速率限制，需实现请求排队和重试
...
- `zhipu_ai_cogvideox3_sdk_summary.md`: 视频 SDK 关键信息
